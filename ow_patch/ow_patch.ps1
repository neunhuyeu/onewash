...
{	
	...
	$json.IoBoardManagerConf.FakeBoard = $true
	$json.IoBoardManagerConf.FakeCF330 = $true
	$json.IoBoardManagerConf.FakeWynide = $true
...
function patch_AutoDiscoveryOptions()
{
	...
	$json.AutoDiscoveryOptions.ListDisabledDevices += "Fake"
	$json | ConvertTo-Json -depth 32 | Format-Json | set-content $file_destination
...
{	
	...
	$json.SystemSettings.Cursor = "default"
...
{	
	...
	$json.UiConfiguration.DisplayPrintTicket = $false
